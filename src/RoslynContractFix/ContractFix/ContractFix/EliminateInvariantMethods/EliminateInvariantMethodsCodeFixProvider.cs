...
{
    [ExportCodeFixProvider(LanguageNames.CSharp, Name = nameof(EliminateInvariantMethodsCodeFixProvider)), Shared]
    public class EliminateInvariantMethodsCodeFixProvider : CodeFixProvider
    {
        private const string title = "Remove Contract Invariant method";
        ...
        public sealed override ImmutableArray<string> FixableDiagnosticIds
        {
            get
            {
                return ImmutableArray.Create(EliminateInvariantMethodsAnalyzer.DiagnosticId);
            }
        }
        ...
        {
            var methodSyntax = nodeToReplace as MethodDeclarationSyntax;
